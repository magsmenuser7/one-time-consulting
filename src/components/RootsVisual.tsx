    ...
    <section className="py-20 bg-gradient-to-br from-green-50 to-blue-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="relative z-10">
          <div className="w-24 h-24 bg-[#7641c8]/20 rounded-full flex items-center justify-center mx-auto mb-8">
            <TreePine className="w-12 h-12 text-[#7641c8]" />
          </div>
          
          <h2 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
            Brands Don't Grow from Ads.
            <span className="text-[#7641c8] block">They Grow from Roots.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-16">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <div className="space-y-4 text-left">
              <div className="flex items-center space-x-3">
                <div className="w-3 h-3 bg-[#7641c8] rounded-full"></div>
