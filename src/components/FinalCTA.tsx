...
const FinalCTA: React.FC = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-black to-[#7641c8]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-12">
          <button className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-black transition-all duration-200 inline-flex items-center">
          ...
          <a
            ...
            className="bg-transparent border-2 border-white text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white hover:text-black transition-all duration-200 inline-flex items-center"
          >
        ...
        <div className="grid md:grid-cols-4 gap-6 max-w-3xl mx-auto">
          ...
          >
            ...
            <span className="text-sm">connect@sanstrategies.com</span>
          </a>
          ...
          <a
            href="https://sanstrategies.com/"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center space-x-2 text-blue-100 hover:text-white transition-colors duration-200"
          >
            <Globe className="w-5 h-5" />
            <span className="text-sm">www.sanstrategies.com</span>
          </a>
